...
public class ProdutoService implements ProdutoUseCase {
    ...
    public Collection<Produto> obterTodosProdutos() {
        var produtos = produtoOutput.obterTodosProdutos();
        if (produtos.isEmpty())
    ...
    public Produto obterProdutoPorId(String id) {
        var produto = produtoOutput.obterProdutoPorId(id);
        if (produto == null)
    ...
    public Collection<Produto> obterProdutoPorCategoria(Integer codigoCategoria) {
        var produtos = produtoOutput.obterProdutoPorCategoria(codigoCategoria);
        if (produtos.isEmpty())
    ...
    public Produto criarProduto(Produto produto) {
        ...
        var categoria = categoriaOutputPort.obterCategoriaPorCodigo(produto.getCategoria().getCodigo());
        if (categoria == null)
