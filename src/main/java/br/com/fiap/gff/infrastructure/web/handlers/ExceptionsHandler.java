...
public class ExceptionsHandler {
    ...
    public ResponseEntity<MensagemErroResponse> notFoundError(RecursoNaoEncontradoException ex,
        ...
        MensagemErroResponse mensagemErro = new MensagemErroResponse(HttpStatus.NO_CONTENT.value(), ex.getMessage(),
    ...
    public ResponseEntity<MensagemErroResponse> requisicaoInvalidaError(RequisicaoInvalidaException ex,
            HttpServletRequest request) {
        MensagemErroResponse mensagemErro = new MensagemErroResponse(HttpStatus.BAD_REQUEST.value(), ex.getMessage(),
                System.currentTimeMillis());
    ...
    public ResponseEntity<MensagemErroResponse> notMappedError(RuntimeException ex, HttpServletRequest request) {
        MensagemErroResponse mensageErro = new MensagemErroResponse(HttpStatus.BAD_REQUEST.value(), ex.getMessage(),
                System.currentTimeMillis());
